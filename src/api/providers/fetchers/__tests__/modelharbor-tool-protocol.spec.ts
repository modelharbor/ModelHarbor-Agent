...
describe("ModelHarbor Tool Protocol Selection", () => {
	...
	it("should set defaultToolProtocol to native for haiku-4.5 models", async () => {
		const mockResponse = {
			data: [
				{
	...
	it("should set defaultToolProtocol to native for sonnet-4 models", async () => {
		const mockResponse = {
			data: [
				{
	...
	it("should handle multiple models with different tool protocols", async () => {
		...
		// Haiku 4.5 should use native protocol
