...
export type EmbedderProvider = "modelharbor" | "openai" | "ollama" | "openai-compatible" | "gemini" // Add other providers as needed
...
export const EMBEDDING_MODEL_PROFILES: EmbeddingModelProfiles = {
	modelharbor: {
		...
		"qwen/qwen3-embedding-4b": { dimension: 2560 }, // TODO: Confirm dimension
	},
	openai: {
...
export function getDefaultModelId(provider: EmbedderProvider): string {
	switch (provider) {
		...
		default:
			...
			console.warn(`Unknown provider for default model ID: ${provider}. Falling back to ModelHarbor default.`)
			return "baai/bge-m3"
	}
}
