...
describe("ClineProvider", () => {
	...
	beforeEach(() => {
		...
		// Override the customModesManager methods since it's readonly
		vi.spyOn(provider.customModesManager, "updateCustomMode").mockImplementation(
			mockCustomModesManager.updateCustomMode,
		)
		vi.spyOn(provider.customModesManager, "getCustomModes").mockImplementation(
			mockCustomModesManager.getCustomModes,
		)
		vi.spyOn(provider.customModesManager, "dispose").mockImplementation(mockCustomModesManager.dispose)
