...
/**
 * Confidence Assessment prompt that is always injected into the system prompt,
 * regardless of whether workspace has .roo/rules/ or not.
 * When rules exist, this is appended to rules output.
 * When no rules exist, it's already included in the customIntructions fallback.
 */
