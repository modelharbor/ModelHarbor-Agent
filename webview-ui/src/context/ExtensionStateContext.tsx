...
import { EMBEDDING_MODEL_PROFILES, type EmbeddingModelProfiles } from "@roo/embeddingModels"
...
export const ExtensionStateContextProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
	const [state, setState] = useState<ExtensionState>({
		...
		codebaseIndexModels: EMBEDDING_MODEL_PROFILES as EmbeddingModelProfiles,
