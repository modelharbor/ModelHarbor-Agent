		...
		<Popover open={open} onOpenChange={setOpen} data-testid="worktree-selector-root">
			<StandardTooltip content={title}>
				<PopoverTrigger
					...
					className={cn(
						"inline-flex gap-1 items-center relative whitespace-nowrap px-3 py-2 w-full",
						"bg-vscode-input-background rounded-lg text-vscode-foreground text-left text-sm",
						"transition-all duration-150 focus:outline-none focus-visible:ring-1 focus-visible:ring-vscode-focusBorder focus-visible:ring-inset",
						"border border-vscode-panel-border",
						disabled
							? "opacity-50 cursor-not-allowed"
							: "opacity-90 hover:opacity-100 hover:bg-vscode-input-background hover:border-vscode-focusBorder cursor-pointer",
					)}>
					...
					<span className="truncate flex-1 font-mono text-vscode-charts-green">
