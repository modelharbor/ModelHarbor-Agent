...
export const PROVIDERS = [
	...
	...[
		...
		{ value: "openai", label: "OpenAI Compatible", proxy: false },
		...
		{ value: "lmstudio", label: "LM Studio", proxy: false },
		{ value: "ollama", label: "Ollama", proxy: false },
		{ value: "unbound", label: "Unbound", proxy: true },
		{ value: "requesty", label: "Requesty", proxy: true },
