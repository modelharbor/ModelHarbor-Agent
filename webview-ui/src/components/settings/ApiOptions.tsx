...
import { SimpleThinkingBudget as _SimpleThinkingBudget } from "./SimpleThinkingBudget"
...
const ApiOptions = ({
	...
	const { organizationAllowList, cloudIsAuthenticated: _cloudIsAuthenticated } = useExtensionState()
