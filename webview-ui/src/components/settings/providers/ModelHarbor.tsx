...
export const ModelHarbor = memo(({ apiConfiguration, setApiConfigurationField }: ModelHarborProps) => {
		...
		<div className="flex flex-col gap-3">
			...
			<div className="text-sm text-vscode-descriptionForeground">
				...
				{!isLoading && !isError && isUsingFallback && (
					<div className="text-xs text-vscode-descriptionForeground mt-1">
						💡 Using fallback models. More models will be available once the extension host loads them from
						the API.
					</div>
				)}
				{!isLoading && !isError && !isUsingFallback && (
