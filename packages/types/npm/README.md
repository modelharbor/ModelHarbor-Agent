# ModelHarbor Agent API

The ModelHarbor Agent extension exposes an API that can be used by other extensions.
...
await api.startNewTask("Hello, ModelHarbor Agent API! Let's make a new project...")
